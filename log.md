...
| 2026-05-28 | FEATURE | capture: Tags row always visible inline in context section with inline add; dialect dropdown uncapped height; settings capture tab: Tags section removed |
