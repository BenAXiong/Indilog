...
|-----------|------|-------------|
| 2026-06-29 17:21 | FEATURE | GoalWidget: compact 3-row layout — row 1: "Goal" + deck chain (→-linked, ≤80% width, ··· if more); row 2: maturity % counters + Sim/Manual pill; row 3: progress bar |
