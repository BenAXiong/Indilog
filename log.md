...
| 2026-06-16 | SCHEMA | Corpus data fix: deleted 66 mis-tagged 馬蘭阿美語 occurrences (source=twelve) whose sentence text matched 建和卑南語 content — 23 lessons affected (L1, L5-6, L10-12); deleted 66 orphaned corpus_sentences rows (glid='01' with Puyuma text); full report in docs/corpus-contamination-report.md |
