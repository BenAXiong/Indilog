...
|-----------|------|-------------|
| 2026-06-29 18:09 | FEATURE | GoalWidget: compact 3-row layout — row 1: "Goal" + deck chain (→-linked, ≤80% width, ··· if more); row 2: maturity % counters + Sim/Manual pill; row 3: progress bar |
| 2026-06-29 18:09 | FEATURE | Curriculum unit priority rows: filter_config JSONB on ind_priority_decks; matchesPriorityDeck helper; listCurriculumUnits/addCurriculumUnitDeck; GoalSheet picker shows "ePark units" section; review/learn pages use matchesPriorityDeck |
| 2026-06-29 18:09 | FIX | Backfill level/lesson/lesson_title for 77 curriculum ind_items (twelve/Lessons source) via corpus_occurrences JOIN; forward-fix EparkView.handleSave to write these fields for twelve source; add level/lesson/lesson_title to CreateItemInput |
