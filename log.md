...
|-----------|------|-------------|
| 2026-06-29 17:21 | FEATURE | GoalWidget: show up to 3 priority decks linked by arrows (→), "···" if more; Sim/Manual pill moved to row 1 alongside "Goal" label; mastery grades still reflect the top collection deck |
