...
const Icon = ({ name, size = 22, color = 'currentColor', strokeWidth = 1.6, style }) => {
  ...
  switch (name) {
    ...
    case 'library':  return <svg {...props}><path d="M4 4v16M8 4v16M14 4l4 16M2 20h20"/></svg>;
    case 'layers':   return <svg {...props}><path d="M12 3l9 5-9 5-9-5 9-5z"/><path d="M3 13l9 5 9-5M3 17l9 5 9-5"/></svg>;
    case 'globe':    return <svg {...props}><circle cx="12" cy="12" r="9"/><path d="M3 12h18M12 3a14 14 0 010 18M12 3a14 14 0 000 18"/></svg>;
    case 'archive':  return <svg {...props}><rect x="3" y="4" width="18" height="4" rx="1"/><path d="M5 8v11a1 1 0 001 1h12a1 1 0 001-1V8M10 13h4"/></svg>;
    case 'share':    return <svg {...props}><path d="M12 3v13M8 7l4-4 4 4M5 14v5a1 1 0 001 1h12a1 1 0 001-1v-5"/></svg>;
    default: return null;
  }
};
